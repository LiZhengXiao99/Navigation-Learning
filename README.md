...
这个仓库会长期更新，做个我学习的记录，内容长期更新，不求有啥回报，有人用得上，能给我带来一些成就感，激励着自己坚持学下去，就挺好了。列的开源代码很多，但其实目前只有 RTKLIB、GAMP、PSINS、GICI、KF-GINS、OB-GINS 内容稍微多一点。
