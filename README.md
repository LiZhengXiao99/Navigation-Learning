...
这个仓库会长期更新，做个我学习的记录，内容长期更新，不求有啥回报，能给我带来一些成就感，满足我小小的虚荣心，激励着自己坚持学下去，就挺好了。列的开源代码很多，但其实目前只有 RTKLIB、GAMP、PSINS、GICI、KF-GINS、OB-GINS 内容稍微多一点。

* **RTKLIB** 我会写的很详细，一遍遍的改。
* **KF-GINS** 已经写的很完善了，就一千五百行代码，学的很熟了。

* **VINS** 和 **ORB-SLAM** 已经有很多高质量的教程，我就不继续更新了。
* **PPPLib**：是我老师写的程序，之前整理过一个函数调用流程图，但以后大概率不继续看了。
* **TGINS**：也是我老师写的程序，最近一直在看，老师让我参照着写代码。
* **GICI-LIb**：写了一些内容，之后有空就会更新。
* **GAMP**：写 PPP 的时候会更新的。
