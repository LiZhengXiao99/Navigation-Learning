...
<table align="center">
    ...
    <tr>
    	...
    	<td>
            ...
            <p>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;北航杨旭博士录的接收机教程，用 FPGA+射频芯片实现硬件接收机，硬件接收机的实现和软件接收机有很大的不同，要额外考虑相当多的工程问题，杨旭这套视频讲的很详细，能给想了解硬件接收机的朋友带来不少帮助。
            </p>
